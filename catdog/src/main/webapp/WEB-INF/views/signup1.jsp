...
<div id="wrap">
	...
	<div id="main">
		<div id="signup1" style="width:70%;">
			<div style="text-align:center;">
				<h3>약관동의</h3><br/>
				<span style="color:gray;">캣츠앤도그의 서비스를 이용하기 위해 이용자는 이용 약관을 읽어보시고 동의하셔야 합니다.<br/>
				회원가입은 무료이며, 가입 즉시 서비스를 이용하실 수 있습니다. 아래의 이용 약관을 반드시 읽고 동의해 주십시오.</span>
			</div>
			<hr style="border:0; height:3px; background:lightgray; margin:20px 0 0;"/>
			<div>
				<h5>이용약관</h5>
				<textarea readonly>
제1조 (목적)

이 약관은 캣츠앤도그(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리의무 및 책임사항을 규정함을 목적으로 합니다.

제2조 (정의)제3조 (약관 등의 명시와 설명 및 개정)

①“몰” 이란 캣츠앤도그가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
				...
				<label>
					<input id="check1" type="checkbox" style="zoom:1.5;">&nbsp;<span>위의 "이용약관"에 동의 합니다.</span>
				</label>
				<h5>개인정보수집 및 활용에 대한 동의</h5>
				<textarea readonly>
'캣츠앤도그'은 회원님께서 웹사이트(이하'캣츠앤도그'이라고 함)의 각종 서비스를 이용하거나'캣츠앤도그'(www.catdog.com)의 상품을 주문하는데 있어, 본인확인, 원활한 서비스 제공 및 주문 접수, 물품 배송, 대금 결제, 회원님에게 유용한 맞춤정보 제공 등을 위하여 필요한 최소한의 개인정보를 필수 사항으로 수집합니다.
...
② “캣츠앤도그 포인트” 서비스 제공을 위한 포인트 적립 및 사용, 정산, 고객센터 운영 등
...
② 이용약관에 따라 자격이 상실 된 회원정보(부정이용 회원의 재발 방지): 5년지할 것입니다.
				...
				<label>
					<input id="check2" type="checkbox" style="zoom:1.5;">&nbsp;<span>위의 "개인정보 수집이용"에 동의 합니다.</span>
				</label>
			</div>
			<button id="button" class="btn btn-danger" disabled>다음</button>
		</div>
	</div>
